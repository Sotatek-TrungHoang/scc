  ...
  codex: {
    ...
    docsReference: {
      ...
      notes: [
        ...
        'SCC-backed Codex launches may apply transient -c overrides and CCS_CODEX_API_KEY',
        'Official docs treat model_providers, mcp_servers, features, and project trust as schema-backed config surfaces',
        'SCC-managed browser tooling for Codex should be configured from Settings > Browser, not by editing the ccs_browser MCP entry directly',
      ],
      links: [
        {
