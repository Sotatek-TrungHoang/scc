...
describe('Config Generator', () => {
  ...
  describe('generateUnifiedConfigContent', () => {
    ...
    it('works with environment variable expansion', () => {
      ...
      assert(normalizedPath.includes('/.ccs/'), 'Should have normalized SCC path');
    });
  ...
  describe('parseUserApiKeys', () => {
    ...
    it('extracts user-added API keys from config content', () => {
      const configContent = `
# CLIProxyAPI config generated by SCC v4
port: 8317
...
`;
    ...
    it('excludes the internal SCC key', () => {
      const configContent = `
api-keys:
  - "ccs-internal-managed"
  - "my-custom-key"
...
`;
  ...
  describe('regenerateConfig API key preservation', () => {
    ...
    it('preserves user API keys during regeneration', () => {
      ...
      const initialConfig = `# CLIProxyAPI config generated by SCC v3
port: 8317
...
`;
      ...
      // Regenerate config (simulating SCC update)
      regenerateConfig();
...
`;
    ...
    it('preserves openai-compatibility connectors during regeneration', () => {
      ...
      const initialConfig = `# CLIProxyAPI config generated by SCC v17
port: 8317
...
`;
  ...
  describe('oauth-model-alias fork:true', () => {
    ...
    it('preserves multiple aliases that share the same model name', () => {
      ...
      const initialConfig = `# CLIProxyAPI config generated by SCC v8
port: 8317
api-keys:
  - "ccs-internal-managed"
auth-dir: "${cliproxyDir.replace(/\\/g, '/')}/auth"
...
`;
    ...
    it('drops stale multi-version Gemini preview ranges while preserving true custom aliases', () => {
      ...
      const initialConfig = `# CLIProxyAPI config generated by SCC v12
port: 8317
api-keys:
  - "ccs-internal-managed"
auth-dir: "${cliproxyDir.replace(/\\/g, '/')}/auth"
...
`;
    ...
    it('does not re-prune multi-version manual clusters once the config is already migrated', () => {
      ...
      const initialConfig = `# CLIProxyAPI config generated by SCC v16
port: 8317
api-keys:
  - "ccs-internal-managed"
auth-dir: "${cliproxyDir.replace(/\\/g, '/')}/auth"
...
`;
    ...
    it('preserves user-added aliases with fork during regeneration', () => {
      ...
      const initialConfig = `# CLIProxyAPI config generated by SCC v6
port: 8317
api-keys:
  - "ccs-internal-managed"
auth-dir: "${cliproxyDir.replace(/\\/g, '/')}/auth"
...
`;
    ...
    it('normalizes deprecated gemini-claude aliases during regeneration', () => {
      ...
      const initialConfig = `# CLIProxyAPI config generated by SCC v9
port: 8317
api-keys:
  - "ccs-internal-managed"
auth-dir: "${cliproxyDir.replace(/\\/g, '/')}/auth"
...
`;
    ...
    it('normalizes dotted deprecated sonnet thinking aliases during regeneration', () => {
      ...
      const initialConfig = `# CLIProxyAPI config generated by SCC v11
port: 8317
api-keys:
  - "ccs-internal-managed"
auth-dir: "${cliproxyDir.replace(/\\/g, '/')}/auth"
